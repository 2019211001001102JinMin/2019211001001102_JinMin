			...
			<div class="table-responsive col-sm-10">
				...
				<thead>
					...
					<c:forEach var="o" items="${orderList}">
						...
						<td>${o.orderDate}</td>
						<%
							com.JinMin.model.Order o=(com.JinMin.model.Order)pageContext.findAttribute("o");
							int userId=o.getCustomerId();
							java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
							com.JinMin.dao.UserDao userDao=new com.JinMin.dao.UserDao();
						...
						<%
							...
							String paymentType=com.JinMin.model.Payment.findByPaymentId(con,n);
							 %>
